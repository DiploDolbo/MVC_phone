      ...
      <View style={styles.ShopUpgrade}>
        ...
        <View style={styles.GameInfoImg}>
          <View style={styles.GameInfo}>
            <Text>Баланс: {money} $</Text>
            <Text>Видюх: {count_VC}/{max_count_VC} </Text>
            <Text>БП: {voltage_VC}/{max_voltage_VC} Вт </Text>
            <Text>Кулер: {count_Cooler}/{max_count_Cooler}</Text>
            <Text>Градусы: {temp_VC}/{max_temp_VC} С° </Text>
            <Text>День: {day}</Text>
            <Text>Налоги: {spentWatts}</Text>
          </View>
        </View>
